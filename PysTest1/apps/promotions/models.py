...
class VIP(models.Model):
    ...
    vip_valid_date = models.DateTimeField(verbose_name=u"有效期", default=datetime.now() + timedelta(days=30))
...
class Coupon(models.Model):
    ...
    coupon_valid_date = models.DateTimeField(verbose_name=u"有效期", default=datetime.now() + timedelta(days=30))
    ...
    get_condition = models.CharField(choices=(("new_user", u"新用户"), ("non_vip", u"非会员"), ("vip", u"会员")),
                                     default="vip", max_length=20, verbose_name=u"获得条件")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
    available_date = models.DateField(default=datetime.now() + timedelta(days=1), verbose_name=u"可领取时间")
